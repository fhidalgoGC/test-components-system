  ...
  return [
    ...
    { 
      ...
      children: [
        ...
        { id: 'google-map-config', label: 'GoogleMap + Config', i18n: { en: 'GoogleMap + Config', es: 'Mapa + Config', default: 'GoogleMap + Config' }, path: '/components/google-map-config', icon: 'Settings' },
        ...
        { id: 'acordion-list', label: 'AcordionList', i18n: { en: 'AcordionList', es: 'Lista Acordeón', default: 'AcordionList' }, path: '/components/acordion-list', icon: 'ListCollapse' },
        ...
        { id: 'loading', label: 'Loading', i18n: { en: 'Loading', es: 'Cargando', default: 'Loading' }, path: '/components/loading', icon: 'Loader' },
