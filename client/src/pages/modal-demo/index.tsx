  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-8">
      ...
      <p className="text-gray-600" data-testid="text-page-description">
        Componente Modal agn&oacute;stico con control 100% externo v&iacute;a useModalController.
      </p>
      ...
      <section className="space-y-4 border rounded-lg p-4">
        ...
        <p className="text-sm text-gray-500">Modal b&aacute;sico con header, body y footer.</p>
        <button
          className="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition"
          onClick={basicModal.open}
          data-testid="button-open-basic"
        >
          Abrir Modal B&aacute;sico
        </button>
        ...
        <Modal
          ...
          header={{
            render: <h3 className="text-lg font-semibold">T&iacute;tulo del Modal</h3>,
            ...
            render: (
              <div className="space-y-3">
                ...
                <p className="text-gray-500 text-sm">
                  Puedes colocar cualquier componente React aqu&iacute;.
                </p>
              </div>
            ),
          }}
      ...
      <section className="space-y-4 border rounded-lg p-4">
        ...
        <p className="text-sm text-gray-500">Cambia el estado del modal para ver c&oacute;mo se renderiza.</p>
      ...
      <section className="space-y-4 border rounded-lg p-4">
        ...
        <p className="text-sm text-gray-500">Modal con overlay personalizado, close button a la izquierda, y layout full.</p>
        <button
        ...
        <Modal
          ...
          header={{
            render: (
              <div>
                <h3 className="text-lg font-semibold text-purple-800">Configuraci&oacute;n Avanzada</h3>
            ...
            render: (
              <div className="space-y-3">
                <div className="bg-purple-50 p-3 rounded">
                  <p className="text-sm">Overlay: color p&uacute;rpura, blur activado, no cierra al hacer click</p>
                </div>
                <div className="bg-purple-50 p-3 rounded">
                  <p className="text-sm">Bot&oacute;n cerrar: posici&oacute;n top-left</p>
                </div>
                <div className="bg-purple-50 p-3 rounded">
