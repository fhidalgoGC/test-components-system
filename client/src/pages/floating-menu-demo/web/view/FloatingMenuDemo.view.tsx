...
export const FloatingMenuDemoWebView = () => {
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody className="font-mono text-xs">
                ...
                <tr className="border-b">
                  <td className="py-2 px-3">offset</td>
                  <td className="py-2 px-3">number</td>
                  <td className="py-2 px-3">8</td>
                  <td className="py-2 px-3 font-sans">Separación del trigger en pixels</td>
                </tr>
                <tr className="border-b">
                  <td className="py-2 px-3">header</td>
                  <td className="py-2 px-3">FloatingMenuSectionConfig</td>
                  <td className="py-2 px-3">-</td>
                  <td className="py-2 px-3 font-sans">Configuración del header</td>
                </tr>
                <tr className="border-b">
                  <td className="py-2 px-3">footer</td>
                  <td className="py-2 px-3">FloatingMenuSectionConfig</td>
                  <td className="py-2 px-3">-</td>
                  <td className="py-2 px-3 font-sans">Configuración del footer</td>
                </tr>
                <tr className="border-b">
                  <td className="py-2 px-3">layout</td>
                  <td className="py-2 px-3">FloatingMenuLayout</td>
                  <td className="py-2 px-3">-</td>
                  <td className="py-2 px-3 font-sans">Configuración de layout</td>
                </tr>
                <tr className="border-b">
                ...
                <tr className="border-b">
                  ...
                  <td className="py-2 px-3">-</td>
                  <td className="py-2 px-3 font-sans">Callback click item</td>
                </tr>
                <tr className="border-b">
                  <td className="py-2 px-3">onClose</td>
                  <td className="py-2 px-3">() =&gt; void</td>
                  <td className="py-2 px-3">-</td>
                  <td className="py-2 px-3 font-sans">Callback cerrar</td>
                </tr>
              </tbody>
            </table>
          </div>
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="font-mono text-xs">
                ...
                <tr className="border-b">
                  ...
                  <td className="py-2 px-3">boolean</td>
                  <td className="py-2 px-3 font-sans">Mostrar/ocultar (desmonta si false)</td>
                </tr>
                <tr className="border-b">
