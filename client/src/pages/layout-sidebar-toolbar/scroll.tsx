import {
  SidebarLayout,
  useSidebarLayout,
} from "@/lib/ui-library/layouts/SidebarLayout";
  ...
  return (
    <div className={styles.mainArea}>
      ...
      <p className={styles.mainText} style={{ marginBottom: 20 }}>
        Este ejemplo tiene mucho contenido para demostrar el scroll automatico
        en el area C. Cuando el contenido excede el espacio disponible, aparece
        scroll vertical.
      </p>
