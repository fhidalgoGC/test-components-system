...
const initialComponents = [
  ...
  { id: 'main', component: <div className={`${styles.demoItem} ${styles['demoItem--success']}`}>Main Content (Slot 2)</div>, align: 'top' as const, slot: 2 },
...
export function HookDemo() {
  ...
  return (
    <section className={styles.section}>
      <h2 className={styles.section__title}>8. Hook useLayoutColumn (Visibilidad Dinámica)</h2>
      ...
      <div className={styles.demoBox} style={{ height: 300 }} data-testid="demo-hook">
        <LayoutColumn
          slots={4}
          widthMode="full"
          heightMode="full"
