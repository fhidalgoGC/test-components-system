      ...
      <div className={styles.gridTwoCol} data-testid="demo-vertical-align">
        {alignOptions.map((align) => (
          <div key={align} className={styles.demoBox}>
            <div className={styles.alignLabel}>verticalAlign: {align}</div>
            <LayoutRow
              slots={3}
              widthMode="full"
              heightMode="fixed"
              ...
              components={[
                {
                  component: (
                    <div
                      className={`w-8 h-8 ${styles.colorBox} ${styles["colorBox--blue"]}`}
                    />
                  ),
                  align: "left",
                  slot: 0,
                },
                {
                  component: (
                    <div
                      className={`w-12 h-4 ${styles.colorBox} ${styles["colorBox--green"]}`}
                    />
                  ),
                  align: "center",
                  slot: 1,
                },
                {
                  component: (
                    <div
                      className={`w-6 h-10 ${styles.colorBox} ${styles["colorBox--purple"]}`}
                    />
                  ),
                  align: "right",
                  slot: 2,
