...
export function AppAuthPropsTab() {
  return (
    <div className={styles.propsContainer}>
      ...
      <p className={styles.propsDescription}>Wrapper que solo renderiza sus children si el usuario está autenticado.</p>
        ...
        <table className={styles.propsTable}>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><code>string</code></td>
              <td><strong>Required</strong></td>
              <td>Ruta de redirección si NO está autenticado</td>
            </tr>
            <tr>
              <td><code>fallback</code></td>
              <td><code>ReactNode</code></td>
              <td><code>undefined</code></td>
              <td>Componente a mostrar mientras redirige (o si no redirige en la demo)</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <p className={styles.propsDescription}>Wrapper que solo renderiza sus children si el usuario NO está autenticado.</p>
        ...
        <table className={styles.propsTable}>
          ...
          <tbody>
            <tr>
              ...
              <td><code>ReactNode</code></td>
              <td><strong>Required</strong></td>
              <td>Contenido a renderizar si NO está autenticado</td>
            </tr>
            <tr>
              <td><code>redirectTo</code></td>
              <td><code>string</code></td>
              <td><strong>Required</strong></td>
              <td>Ruta de redirección si YA está autenticado</td>
            </tr>
            <tr>
              <td><code>fallback</code></td>
              <td><code>ReactNode</code></td>
              <td><code>undefined</code></td>
              <td>Componente a mostrar mientras redirige</td>
            </tr>
          </tbody>
        </table>
      </div>
